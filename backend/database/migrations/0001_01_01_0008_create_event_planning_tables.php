...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('event_plan_connections')) {
        ...
        if (!Schema::hasTable('event_plan_drawings')) {
        ...
        if (!Schema::hasTable('event_plan_nodes')) {
        ...
        if (!Schema::hasTable('seat_tables')) {
        ...
        // Archive table
        if (!Schema::hasTable('event_plan_connections_archive')) {
        ...
        // Archive table
        if (!Schema::hasTable('event_plan_drawings_archive')) {
        ...
        // Archive table
        if (!Schema::hasTable('event_plan_nodes_archive')) {
        ...
        // Archive table
        if (!Schema::hasTable('event_plans_archive')) {
        ...
        // Archive table
        if (!Schema::hasTable('seat_assignments_archive')) {
        ...
        // Archive table
        if (!Schema::hasTable('seat_plans_archive')) {
        ...
        // Archive table
        if (!Schema::hasTable('seat_tables_archive')) {
